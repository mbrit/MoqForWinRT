...
#pragma warning restore 1584, 1580, 1574
		                                                              ...
		                                                              params IInterceptor[] interceptors)
		{
			...
			if (target != null && interfaceToProxy.IsInstanceOf(target) == false)
			{
		...
		public TInterface CreateInterfaceProxyWithoutTarget<TInterface>(ProxyGenerationOptions options,
			...
			where TInterface : class
		{
			return (TInterface)CreateInterfaceProxyWithoutTarget(typeof(TInterface), TypeExtender.EmptyTypes, options, interceptors);
		}
		...
		{
			return CreateInterfaceProxyWithoutTarget(interfaceToProxy, TypeExtender.EmptyTypes, ProxyGenerationOptions.Default,
			                                         interceptor);
		}
		...
		public object CreateInterfaceProxyWithoutTarget(Type interfaceToProxy, ProxyGenerationOptions options,
		                                                params IInterceptor[] interceptors)
		{
			return CreateInterfaceProxyWithoutTarget(interfaceToProxy, TypeExtender.EmptyTypes, options, interceptors);
		}
