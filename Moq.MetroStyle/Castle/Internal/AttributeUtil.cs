...
namespace Castle.DynamicProxy.Internal
{
...
#if NETFX_CORE
		public static IEnumerable<CustomAttributeBuilder> GetNonInheritableAttributes(this Type member)
		{
 ...
 as Attribute
				...
				catch (ArgumentException e)
				{
					var message =
						string.Format(
							...
							attributeType.FullName, member.FullName, member
);
		...
		{
			var constructor = typeof(TAttribute).GetConstructor(TypeExtender.EmptyTypes);
