...
namespace Castle.DynamicProxy.Generators
{
	...
	public abstract class BaseProxyGenerator
	{
		...
		protected void GenerateParameterlessConstructor(ClassEmitter emitter, Type baseClass, FieldReference interceptorField)
		{
			...
			var defaultConstructor = baseClass.GetConstructor(BindingFlags.Public | BindingFlags.Instance, null, TypeExtender.EmptyTypes,
			                                                  null);

			if (defaultConstructor == null)
			{
				defaultConstructor = baseClass.GetConstructor(BindingFlags.NonPublic | BindingFlags.Instance, null, TypeExtender.EmptyTypes,
				                                              null);
