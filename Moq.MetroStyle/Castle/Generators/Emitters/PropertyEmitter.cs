...
namespace Castle.DynamicProxy.Generators.Emitters
{
	...
	public class PropertyEmitter : IMemberEmitter
	{
		...
		{
			return CreateGetMethod(name, attributes, methodToOverride, TypeExtender.EmptyTypes);
		}
		...
		{
			var method = CreateSetMethod(name, attributes, methodToOverride, TypeExtender.EmptyTypes);
			return method;
		}
